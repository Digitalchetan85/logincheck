      ...
      >
        <Container>
          <Row>
            <Col md={12}>
              <div className="">
                <h2 className="text-center text-white">Refund Policy</h2>
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb justify-content-center">
                    ...
                    <li className="breadcrumb-item">Refund Policy</li>
                  </ol>
                </nav>
              </div>
            </Col>
            ...
            <Col md={8}>
              ...
              <ul>
                <li>
                  ...
                  “our,” it refers to Digital Agility Institute, that is
              ...
              <p>
                ...
                Digital Agility Institute, you agree to the terms set forth
                below along with Policy.
              </p>

              <p>
                If there’s something wrong with the product/service you bought,
                or if you are not happy with it, you will not be able to issue a
              ...
              <p>
                ...
                items won’t get damaged during transit. Please note that Digital
                Agility Institute is not liable for damages that are caused to
                the items during transit or transportation.
              </p>
              ...
              <ul>
                ...
                <li>
                  ...
                  shipping, a refund can be processed. Orders generally take 1-2
                  days to process before dispatch.
                </li>
                <li>
              ...
              <p>
                ...
                be bound by the updated Return & Refund Policy. If you do not
                want to agree to this or any updated Return & Refund Policy, you
              ...
              <ul>
                ...
                <li>
                  -Via this Link: http://digitalagilityinstitute.com/contact-us
                </li>
              </ul>
            </Col>
          </Row>
